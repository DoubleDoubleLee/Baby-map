...
@interface LSSBabyFoodViewController ()

@end

@implementation LSSBabyFoodViewController
...
- (void)loadData
{
    [self loadDataWithPath:[NSString stringWithFormat:Food_URL, self.page]];
